<div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Pengelola</p>
                <h3 class="card-title"><?php echo $pengelola; ?></h3>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Dinas</p>
                <h3 class="card-title"><?php echo $dinas; ?></h3>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card card-stats">
            ...
            <div class="card-content">
                <p class="category">Petani</p>
                <h3 class="card-title"><?php echo $petani; ?></h3>
            </div>
        </div>
    </div>
</div>
